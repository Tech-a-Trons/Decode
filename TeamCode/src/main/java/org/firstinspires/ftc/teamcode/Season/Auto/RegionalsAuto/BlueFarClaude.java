...
@Autonomous(name = "BlueFarClaude", group = "Examples")
public class BlueFarClaude extends NextFTCOpMode {

    public BlueFarClaude() {
        addComponents(
    ...
    // ── Poses ─────────────────────────────────────────────────────────────
    private final Pose startPose = new Pose(87.707, 8.328, Math.toRadians(0)).mirror();
    private final Pose scorePose = new Pose(87.031, 17.521, Math.toRadians(0)).mirror();
    ...
    public void buildPaths() {
        ...
        grabPrePickup1 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Pose(87.031, 17.521).mirror(),
                                new Pose(85.540, 36.086).mirror(),
                                new Pose(131.133, 37.447).mirror()
                        )
        ...
        grabPickup3 = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                new Pose(87.161, 17.288).mirror(),
                                new Pose(133.751, 20.479).mirror()
                        )
                ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                .addPath(
                        new BezierLine(
                                new Pose(133.751, 20.479).mirror(),
                                new Pose(133.929, 15.597).mirror()
                        )
                ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                .build();
