...
@Disabled
@TeleOp(name = "Dual Shooter Test", group = "Linear Opmode")
public class Dual_Shooter_Test extends LinearOpMode {
    float outtakePower = 0.7F;
...
//        DcMotor M4 = hardwareMap.get(DcMotor.class, "BootKicker1");
        ...
        while (opModeIsActive()) {
            ...
            if(gamepad1.left_bumper){
                outtakePower = (float) outtakePower - 0.05F;
            }
