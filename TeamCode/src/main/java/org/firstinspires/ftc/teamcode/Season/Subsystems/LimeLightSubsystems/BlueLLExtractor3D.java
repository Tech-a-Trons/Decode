...
public class BlueLLExtractor3D {
    ...
    private static final double BLUE_GOAL_X = -121.0;   // Red goal X position (inches)
    private static final double BLUE_GOAL_Y = 121.0;   // Red goal Y position (inches)
    ...
    private static final int PIPELINE = 5;  // Pipeline 4 for RED alliance MegaTag2
    ...
    public double getAngleToGoalVision() {
        if (hasBotpose) {
            ...
            return calculateAngleToTargetVision(BLUE_GOAL_X, BLUE_GOAL_Y);
        } else {
    ...
    public void displayTelemetry() {
        telemetry.addLine("========== BLUE ALLIANCE (HYBRID LOCALIZATION) ==========");
