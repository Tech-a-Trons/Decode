...
/**
 * RED ALLIANCE - Limelight MegaTag2 + Pinpoint Odometry Fusion Subsystem
 * Uses Pipeline 0 for RED alliance
...
public class RedLLExtractor3D {
    ...
    // ========== RED ALLIANCE TARGET ==========
    private static final double RED_GOAL_X = 121.0;   // Red goal X position (odometry units)
    private static final double RED_GOAL_Y = 121.0;   // Red goal Y position (odometry units)
    ...
    private static final int PIPELINE = 0;  // Pipeline 0 for RED alliance MegaTag2
    ...
    /**
     * Initialize the RED Limelight Localization Subsystem
    ...
    public RedLLExtractor3D(HardwareMap hardwareMap, Telemetry telemetry) {
        ...
        // Set to MegaTag2 pipeline (Pipeline 0 for RED)
        limelight.pipelineSwitch(PIPELINE);

        // Start polling for data
        limelight.start();

        telemetry.addLine("RED Limelight MegaTag2 Subsystem Initialized");
