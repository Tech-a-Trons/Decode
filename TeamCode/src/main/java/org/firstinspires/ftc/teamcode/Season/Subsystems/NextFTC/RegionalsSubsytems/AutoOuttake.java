...
//@Config
public class AutoOuttake implements Subsystem {

    public static final AutoOuttake INSTANCE = new AutoOuttake();
    ...
    public static MotorGroup turret1 = new MotorGroup(
            new MotorEx("outtakeleft"),
            new MotorEx("outtakeright").reversed()
    );

    ControlSystem controller = ControlSystem.builder()
            .velPid(0.015, 0, 0) // Velocity PID with 0.007
