...
public class RTenDegreeLL implements Subsystem {
    ...
    public RTenDegreeLL(HardwareMap hardwareMap, RedExperimentalDistanceLExtractor limelight, VoltageGet voltageGet) {
