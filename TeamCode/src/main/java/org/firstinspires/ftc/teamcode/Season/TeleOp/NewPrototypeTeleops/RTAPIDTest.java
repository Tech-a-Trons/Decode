...
public class RTAPIDTest extends NextFTCOpMode {
    public RTAPIDTest() {
        addComponents(
                new SubsystemComponent(TurretPID.INSTANCE, Hood.INSTANCE, Turret.INSTANCE, RedTurretAlign.INSTANCE),
    ...
    public  RedExperimentalDistanceLExtractor ll;
...
//
   ...
   private final MotorEx outr = new MotorEx("outtakeright");
    ...
    public void onStartButtonPressed() {
        ...
        redAlign = new RedTurretAlign();
//
        redAlign.INSTANCE.initHardware(hardwareMap);
        ll = new RedExperimentalDistanceLExtractor(hardwareMap);
        redAlign.INSTANCE.setLimelight(ll);
