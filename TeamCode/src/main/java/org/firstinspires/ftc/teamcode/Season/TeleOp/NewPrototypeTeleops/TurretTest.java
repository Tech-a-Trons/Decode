...
//    public TurretTest() {
//        addComponents(
//                new SubsystemComponent(Turret.INSTANCE,Outtake.INSTANCE),
...
//        Gamepads.gamepad1().a()
//                .whenTrue(() -> Outtake.INSTANCE.setShooterSpeed());
//        Gamepads.gamepad1().x()
//                .whenTrue(() -> Outtake.INSTANCE.resetShooter()); // run intake while held
//        Gamepads.gamepad1().dpadUp()
//                .whenTrue(() -> Turret.INSTANCE.open())   // run intake while held
//                .whenFalse(() -> Turret.INSTANCE.close()); // stop intake when released
//
