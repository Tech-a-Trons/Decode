...
//@Configurable
//@TeleOp
//public class TuningTeleop extends NextFTCOpMode {
//
...
//    public static double VelocityOuttake = 0;
...
//        TurretPID.INSTANCE.setShooterSpeed(VelocityOuttake);
//        Hood.INSTANCE.set(Hoodpos);
//        if (!automatedDrive) {
